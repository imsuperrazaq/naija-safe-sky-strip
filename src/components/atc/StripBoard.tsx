...
export const StripBoard = ({
  ...
  return (
    <div className="flex flex-col h-full">
      <div className={cn(
        "bg-slate-800 text-white py-1.5 px-3 font-medium tracking-wide border-t-4",
      ...
      <Droppable droppableId={droppableId}>
        {(provided, snapshot) => (
          <div 
            ...
            className={cn(
              "flex-1 overflow-y-auto p-2 bg-slate-950/80",
              snapshot.isDraggingOver && "bg-slate-800/70 ring-1 ring-inset ring-blue-500/30"
            )}
          >
